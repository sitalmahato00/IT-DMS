@php
    ...
    $isNoticeBoard = request()->routeIs('admin.notice-board*') && request('status') !== 'published';
    $isAnnouncements = request()->routeIs('admin.notice-board*') && request('status') === 'published';
    ...
    $activeGroup = match (true) {
        ...
        $isNoticeBoard || $isAnnouncements => 'announcement',
...
>
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        <div class="rounded-2xl border border-red-500/20 bg-white shadow-[0_15px_30px_rgba(0,0,0,0.08)] px-2 py-4 space-y-2">
            ...
            <a href="{{ route('admin.dashboard') }}" class="nav-link flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ $isDashboard ? 'bg-red-600 text-white shadow-sm' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                <i class="bi bi-speedometer2 text-lg flex-shrink-0"></i>
                <span class="sidebar-label">{{ __('Dashboard') }}</span>
            </a>

            <button type="button" @click="toggleGroup('users')" :class="activeGroup === 'users' ? 'text-red-600 bg-red-50 border border-red-100 shadow-sm' : 'text-slate-600 bg-white'" class="w-full flex items-center justify-between gap-2.5 px-3 py-2 rounded-lg text-sm font-semibold transition-all duration-150">
            ...
            <div class="collapsible-section space-y-0.5 overflow-hidden transition-all duration-300" x-show="activeGroup === 'users'" x-collapse>
                <a href="{{ route('admin.students') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isStudents ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-mortarboard text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Students') }}</span>
                </a>
                <a href="{{ route('admin.teachers') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isTeachers ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-person-badge text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Teachers') }}</span>
                </a>
                <a href="{{ route('admin.parents') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isParents ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-people text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Parents') }}</span>
                </a>
                <a href="{{ route('admin.alumni-students') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isAlumni ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
            ...
            <div class="collapsible-section space-y-0.5 overflow-hidden transition-all duration-300" x-show="activeGroup === 'academics'" x-collapse>
                ...
                <a href="{{ route('admin.courses') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isSubjects ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-book-half text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Subjects') }}</span>
                </a>
                <a href="{{ route('admin.electives') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isElectives ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
            ...
            <div class="collapsible-section space-y-0.5 overflow-hidden transition-all duration-300" x-show="activeGroup === 'schedule'" x-collapse>
                <a href="{{ route('admin.timetable') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isTimetable ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
            ...
            <div class="collapsible-section space-y-0.5 overflow-hidden transition-all duration-300" x-show="activeGroup === 'attendance'" x-collapse>
                <a href="{{ route('admin.attendance') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isAttendance ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
            ...
            <div class="collapsible-section space-y-0.5 overflow-hidden transition-all duration-300" x-show="activeGroup === 'resources'" x-collapse>
                <a href="{{ route('admin.study-material') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isDocuments ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-journal-bookmark text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Documents') }}</span>
                </a>
                <a href="{{ route('admin.notifications') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isNotifications ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-bell text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Notifications') }}</span>
                </a>
                <a href="{{ route('admin.gallery') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isGallery ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
            ...
            <div class="collapsible-section space-y-0.5 overflow-hidden transition-all duration-300" x-show="activeGroup === 'announcement'" x-collapse>
                <a href="{{ route('admin.notice-board') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isNoticeBoard ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-megaphone text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Notice Board') }}</span>
                </a>
                <a href="{{ route('admin.notice-board', ['status' => 'published']) }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isAnnouncements ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-chat-square-text text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Announcements') }}</span>
                </a>
            </div>
            ...
            <div class="collapsible-section space-y-0.5 overflow-hidden transition-all duration-300" x-show="activeGroup === 'exam'" x-collapse>
                <a href="{{ route('admin.exam') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isExams ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-file-earmark-text text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Exams') }}</span>
                </a>
                <a href="{{ route('admin.marks') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isLedger ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-clipboard-data text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Ledger') }}</span>
                </a>
                <a href="{{ route('admin.marksheet.search') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isMarksheet ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
            ...
            <div class="collapsible-section space-y-0.5 overflow-hidden transition-all duration-300" x-show="activeGroup === 'system'" x-collapse>
                <a href="{{ route('admin.reports') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isReports ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-bar-chart text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Reports') }}</span>
                </a>
                <a href="{{ route('admin.audit-logs.index') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isAuditLogs ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-journal-text text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Audit Logs') }}</span>
                </a>
                <a href="{{ route('admin.department.edit') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isDepartment ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
                    <i class="bi bi-building text-base flex-shrink-0"></i>
                    <span class="sidebar-label">{{ __('Department') }}</span>
                </a>
                <a href="{{ route('admin.settings') }}" class="nav-link flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-150 {{ $isSettings ? 'bg-red-600 text-white' : 'text-slate-600 hover:text-[#FF0037] hover:bg-red-500/10' }}">
