...
@section('title', $course->subject_name)
...
<div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('admin.courses.edit', $course->id) }}" class="bg-red-600 hover:bg-red-700 text-white px-3 py-1.5 rounded text-xs flex items-center gap-1.5 transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
        ...
        <div class="bg-white p-4 rounded shadow-sm border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-600 text-xs font-medium">Instructor</p>
                    <p class="text-lg font-bold text-gray-900 mt-1 truncate">{{ $course->teacher_name ?? 'Not Assigned' }}</p>
                </div>
                ...
                <ul class="space-y-2 text-sm">
                    @foreach(array_filter(array_map('trim', explode("\n", $course->syllabus))) as $item)
                        ...
                        <li class="flex items-start gap-2">
                            <i class="bi bi-chevron-right text-red-500 mt-0.5 text-xs"></i>
    ...
    <div class="bg-white p-4 rounded shadow-sm border border-gray-200">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('admin.courses.edit', $course->id) }}" class="px-3 py-1.5 bg-red-100 hover:bg-red-200 text-red-700 rounded text-xs flex items-center gap-1.5 transition">
