            ...
            <div class="flex flex-wrap gap-2">
                @foreach($children as $child)
                    <a
                        ...
                        class="parent-smooth-chip inline-flex items-center gap-2 rounded-full px-3 py-2 text-sm font-medium transition {{ $selectedChildId === $child['id'] ? 'bg-red-600 text-white shadow-sm' : 'bg-red-50 text-red-700 hover:bg-red-100 dark:bg-red-950/20 dark:text-red-200 dark:hover:bg-red-950/30' }}"
                    >
