        ...
        <div class="flex items-center justify-between gap-4 h-full">
            ...
            <div class="flex items-center gap-2 flex-shrink-0 h-full">
                <div class="hidden md:block">
                    ...
                    <select id="locale-select" class="px-3 py-1.5 border border-gray-200 rounded-full text-sm text-gray-900 bg-white cursor-pointer focus:ring-2 focus:ring-red-500 focus:border-transparent shadow-sm transition dark:bg-slate-900 dark:text-white dark:border-slate-700">
