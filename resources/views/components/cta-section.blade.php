<section class="relative bg-gradient-to-r from-red-600 via-red-600 to-red-700 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto text-center relative z-10">
        ...
        <!-- Trust Indicators -->
        <div class="grid grid-cols-3 gap-6 md:gap-12 text-white pt-8 border-t border-white border-opacity-20">
            <div class="group cursor-pointer hover:scale-110 transition-transform duration-300">
                ...
                <p class="text-sm text-red-100 mt-1">Support</p>
            </div>
            <div class="group cursor-pointer hover:scale-110 transition-transform duration-300">
                <p class="text-4xl font-bold group-hover:text-red-100 transition">100%</p>
                <p class="text-sm text-red-100 mt-1">Secure</p>
            </div>
            <div class="group cursor-pointer hover:scale-110 transition-transform duration-300">
                <p class="text-4xl font-bold group-hover:text-red-100 transition">Free</p>
                <p class="text-sm text-red-100 mt-1">Setup</p>
            </div>
        </div>
    </div>
</section>
