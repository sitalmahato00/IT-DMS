...
<div class="space-y-6 @if(app()->getLocale() === 'ne') locale-ne @endif">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">{{ __('Notifications') }}</h1>
    ...
    <div class="space-y-3">
        @if($notifications->isNotEmpty())
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition {{ !$notification['read_at'] ? 'border-l-4 border-l-blue-500' : '' }}">
