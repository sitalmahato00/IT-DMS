...
@section('content')
<div class="teacher-smooth-page teacher-reports-page space-y-6">
    <!-- Page Header -->
    <div class="teacher-page-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="min-w-0">
            <h1 class="teacher-page-header-title text-2xl font-bold text-gray-800 dark:text-white">{{ __('My Reports') }}</h1>
    ...
    <div class="teacher-filter-panel bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
        <form method="GET" action="{{ route('teacher.reports') }}" class="space-y-4">
            ...
            <div class="flex items-center gap-2">
                <button type="submit" class="teacher-page-primary-btn inline-flex items-center gap-2 px-4 py-2 bg-red-600 text-white rounded-md text-sm hover:bg-red-700 transition-colors font-medium">
                    <i class="bi bi-funnel"></i> {{ __('Filter') }}
                </button>
                <a href="{{ route('teacher.reports') }}" class="teacher-page-secondary-btn inline-flex items-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 dark:text-gray-300 rounded-md text-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors font-medium">
    ...
    <div class="teacher-stats-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="teacher-stat-card bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5">
            <div class="flex items-center justify-between">
                ...
                <div class="teacher-smooth-icon w-10 h-10 bg-amber-100 dark:bg-amber-900 rounded-lg flex items-center justify-center text-amber-600 dark:text-amber-400">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="teacher-smooth-panel bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <div class="p-5">
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="teacher-smooth-kpi-bar w-32 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
        ...
        <div class="teacher-smooth-panel bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <div class="p-5">
                <div class="grid grid-cols-2 gap-4">
                    <div class="teacher-smooth-summary-box text-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
    ...
    <div class="teacher-smooth-panel bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-5">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="{{ route('teacher.attendance') }}" class="teacher-smooth-quicklink flex items-center gap-3 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 transition">
                    <div class="teacher-smooth-icon w-10 h-10 bg-red-100 dark:bg-red-900/40 rounded-full flex items-center justify-center">
                ...
                <a href="{{ route('teacher.marks') }}" class="teacher-smooth-quicklink flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition">
                    <div class="teacher-smooth-icon w-10 h-10 bg-blue-100 dark:bg-blue-900/40 rounded-full flex items-center justify-center">
                ...
                <a href="{{ route('teacher.exams') }}" class="teacher-smooth-quicklink flex items-center gap-3 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition">
                    <div class="teacher-smooth-icon w-10 h-10 bg-purple-100 dark:bg-purple-900/40 rounded-full flex items-center justify-center">
                ...
                <a href="{{ route('teacher.students') }}" class="teacher-smooth-quicklink flex items-center gap-3 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 transition">
                    <div class="teacher-smooth-icon w-10 h-10 bg-red-100 dark:bg-red-900/40 rounded-full flex items-center justify-center">
