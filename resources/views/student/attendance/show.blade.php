...
@section('title', $subject->localized_name . ' - ' . __('Subject Dashboard'))
        ...
        <div class="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div class="max-w-3xl">
                ...
                <div class="mt-5 flex flex-wrap gap-3">
                    <a href="{{ route('student.attendance') }}" class="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2.5 text-sm font-semibold text-[#B2002F] shadow-lg shadow-black/10 transition hover:-translate-y-0.5">
                        <i class="bi bi-arrow-left"></i>
                        <span>{{ __('Back to Attendance') }}</span>
                    </a>
                    <a href="{{ route('student.courses.show', $subject->id) }}" class="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-white/15">
                        <i class="bi bi-journal-bookmark"></i>
                        <span>{{ __('Course View') }}</span>
                    </a>
                </div>
            </div>
            ...
            <section class="student-smooth-panel rounded-[1.75rem] border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('Attendance and marks visualized in the same color language as the rest of the portal.') }}</p>
                    </div>
            ...
            <section class="student-smooth-panel rounded-[1.75rem] border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('The syllabus text is pulled directly from the subject table, so the page always reflects the admin update.') }}</p>
                    </div>
        ...
        <div class="xl:col-span-4 space-y-6">
            <section class="student-smooth-panel rounded-[1.75rem] border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
                <div class="flex items-center justify-between gap-3">
                    <div>
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white">{{ __('Subject Details') }}</h2>
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('Quick facts from the subject profile') }}</p>
                    </div>
                    <div class="rounded-2xl bg-red-50 p-3 text-red-700 dark:bg-red-950/30 dark:text-red-300">
            ...
            <section class="student-smooth-panel rounded-[1.75rem] border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
                <div class="flex items-center justify-between gap-3">
                    <div>
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white">{{ __('Instructor') }}</h2>
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('Primary subject teacher') }}</p>
                    </div>
                    <i class="bi bi-person-badge text-2xl text-red-600 dark:text-red-300"></i>
                </div>

                <div class="mt-4 rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/40">
                    <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ $primaryTeacher ? $primaryTeacher->name : __('Not assigned yet') }}</p>
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('Primary instructor for this subject') }}</p>
                </div>
            ...
            <section class="student-smooth-panel rounded-[1.75rem] border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6">
                <div class="flex items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('How the subject is currently trending') }}</p>
                    </div>
